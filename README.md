...
1. [Setup - The basics of getting started with moodle](#setup)
    * [What moodle affects](#what-moodle-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with moodle](#beginning-with-moodle)
